...
const TaskCard = ({ task }) => {
  ...
  return (
    <>
      <div className='w-full h-fit bg-[#EEEEEE] shadow-md p-5 rounded-[10px]'>
        <div className='w-full flex justify-between'>
          <div
            className={clsx(
              "flex flex-1 gap-1 items-center text-small font-[1rem]",
        ...
        {task?.subTasks?.length > 0 ? (
          <div className='py-5 border-t border-gray-200'>
            ...
            <div className='p-5 space-x-8'>
              ...
              <span className='bg-[#393E46]/10 px-3 py-1 rounded0full text-[#393E46] font-medium'>
                {task?.subTasks[0].tag}
              </span>
            </div>
          </div>
