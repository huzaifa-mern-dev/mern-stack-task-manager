    ...
    <>
      <div>
        <Menu as='div' className='relative inline-block text-left'>
          <Menu.Button className='inline-flex w-full justify-center rounded-md px-4 py-2 text-medium font-medium text-gray-600 '>
            <BsThreeDots />
          </Menu.Button>
                  ...
                  <Menu.Item key={el.label}>
                    {({ active }) => (
                      <button
                        onClick={el?.onClick}
                        className={`${
                          active ? "bg-[#393E46] text-white" : "text-gray-900"
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      ...
                      className={`${
                        active ? "bg-[#393E46] text-white" : "text-red-900"
                      } group flex w-full items-center rounded-md px-2 py-2 text-sm`}
                    >
                      <RiDeleteBin6Line
